...
sha256sums=('7d1344c5433b91823f02c2e40b33d181fa6faf286bea5591f4b1965f23d45f6c'
            ...
            '94b72f87d60d283648f74aba86aaafd78fc72ae8c2180c996269dae88539cd03')
b2sums=('7e4780092c0a87d5d187cd5734ddc736574db80b500f155287640ef2230e09335cc9b6b26ec1b7d8ab1b7942673ea49a3007a81da372a6d2ac36f3908913045c'
        ...
        '1b183ce0b533fc0cc3aaab787565b7561fdc282049ef686f3d2e4e08fca5fc771a60fa4495c91ec9b1976401fbb015c0e1369a6d0b791dc71954441ea851e2ed')
validpgpkeys=('4F3BA9AB6D1F8D683DC2DFB56AD860EED4598027'  # Tony Hutter (GPG key for signing ZFS releases) <hutter2@llnl.gov>
              'C33DF142657ED1F7C328A2960AB9E991C6AF658B') # Brian Behlendorf <behlendorf1@llnl.gov>

prepare() {
    cd "${srcdir}"/zfs-${pkgver}
    patch --strip=1 --input=../keyname.patch
